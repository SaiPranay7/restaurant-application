...
public class App {
    ...
    private static RestHandlerBuilder createRestHandler() {
        Map<Integer, RestaurantBooking.Customer> customers = new HashMap<>();
         RestaurantBooking.Customer customer = new RestaurantBooking.Customer();
        ...
        return RestHandlerBuilder.restHandler(new JaxRSExample.UserResource(customers))
            .withCORS(
